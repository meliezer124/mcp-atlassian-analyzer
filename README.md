...
- `jira_get_issue_dates`: Get raw date and timeline data for workflow analysis
- `jira_get_issue_sla`: Calculate SLA metrics (cycle time, lead time, time in status, etc.)
